...
cor(predicted.lm, house_models.test$price.log)^2
...
cor(predicted.gam, house_models.test$price.log)^2
```
...
cor(predicted.tree, house_models.test$price.log)^2
...
cor(predicted.neural, house_models.test$price.log)^2
